...
import ScrollPath from "../components/hero/ScrollPath"
        ...
        <div className="grid grid-cols-12 gap-6 items-center">
          ...
          <div className="col-span-12 md:col-span-5 flex flex-col justify-center pt-28 pb-24">
            ...
            <div className="flex items-center gap-2.5 mb-8 self-start">
              ...
              <span className="text-[13px] text-ink-muted font-medium tracking-[0.06em] uppercase">
            ...
            <p className="text-[16px] leading-[1.65] text-ink-muted max-w-[400px] mb-10">
            ...
            <div className="flex items-center gap-4 flex-wrap">
              <Link to="/map" className="bg-accent text-base-dark px-8 py-4 rounded-xl font-semibold text-[15px] hover:bg-accent-light active:scale-[0.98] transition-all">
                Explore Inventory
              </Link>
              <Link to="/dashboard" className="border border-[rgba(242,239,233,0.18)] text-ink px-8 py-4 rounded-xl font-semibold text-[15px] hover:border-[rgba(242,239,233,0.36)] hover:bg-[rgba(242,239,233,0.04)] transition-all">
                View Demo
              </Link>
            </div>
          </div>
          {/* Right side — open space; path + terrain patch visible here */}
      ...
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="flex justify-end mb-16">
          <div className="max-w-[480px]">
            <span className="text-[12px] font-semibold tracking-[0.14em] uppercase text-ink-muted mb-3 block">
              Features
            </span>
        ...
        <div className="grid grid-cols-2 gap-5 max-w-[680px] ml-auto">
          {features.map((feat, i) => (
            <div
              key={feat.num}
              className={`bg-card/90 backdrop-blur-sm border border-border rounded-2xl p-7 flex flex-col transition-colors hover:border-[rgba(242,239,233,0.14)] ${
                i === 1 ? "mt-10" : i === 2 ? "mt-5" : i === 3 ? "mt-14" : ""
              }`}
            >
      ...
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="grid grid-cols-12 gap-8 items-center">
          <div className="col-span-12 md:col-span-5 flex flex-col justify-center">
            <span className="text-[12px] font-semibold tracking-[0.14em] uppercase text-ink-muted mb-4 block">
              Network
            </span>
            <h2 className="font-display text-[40px] leading-[1.15] tracking-[-0.025em] text-ink mb-5">
              One unified map, every facility.
            </h2>
            <p className="text-[16px] leading-[1.65] text-ink-muted mb-10 max-w-[360px]">
...
function StatsBand() {
  ...
  return (
    <section className="relative py-24 bg-card/80 backdrop-blur-md border-y border-border overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="grid grid-cols-4 gap-8 md:gap-12">
          {stats.map((stat, i) => (
            <div key={i} className="flex flex-col">
              ...
              <span className="text-[12px] uppercase tracking-[0.10em] text-ink-muted font-medium">
                {stat.label}
              </span>
            </div>
          ))}
      ...
      <div className="max-w-[1440px] mx-auto px-16">
        ...
        <div className="grid grid-cols-3 gap-5 max-w-[860px] ml-auto">
          {cards.map((card, i) => (
            <div
              key={i}
              className={`bg-card/90 backdrop-blur-sm border border-border rounded-2xl p-7 flex flex-col hover:border-[rgba(242,239,233,0.14)] transition-colors ${
                i === 1 ? "mt-8" : ""
              }`}
            >
              <div
...
function PartnerStrip() {
  ...
  return (
    <section className="py-12 border-t border-border relative z-10">
      <div className="max-w-[1440px] mx-auto px-16">
        <p className="text-[11px] uppercase tracking-[0.14em] text-ink-muted mb-8 text-center">
...
function Footer() {
  return (
    <footer className="relative pt-20 pb-14 border-t border-border z-10">
      <div className="max-w-[1440px] mx-auto px-16">
        <div className="flex items-center gap-3 mb-16">
          ...
          <span className="text-[13px] text-ink-muted font-medium">Delivery complete — every product located.</span>
        </div>

        <div className="grid grid-cols-12 gap-8 mb-16">
          <div className="col-span-4">
            <div className="font-display font-bold text-[28px] mb-4 text-ink">Lokate.</div>
            <p className="text-[14px] leading-[1.65] text-ink-muted max-w-xs">
          ...
          <div className="col-span-2 col-start-7 flex flex-col gap-3">
            ...
            {[{label: "Network Map", path: "/map"}, {label: "Inventory Search", path: "/search"}, {label: "Dashboard", path: "/dashboard"}].map((link) => (
              <Link key={link.label} to={link.path} className="text-[14px] text-ink-muted hover:text-ink transition-colors">
                {link.label}
              </Link>
            ))}
          </div>
          ...
          <div className="col-span-2 flex flex-col gap-3">
            ...
            {["About Us", "Careers", "Blog", "Contact"].map((link) => (
              <a key={link} href="#" className="text-[14px] text-ink-muted hover:text-ink transition-colors">
                {link}
              </a>
            ))}
          </div>
        ...
        <div className="pt-8 border-t border-border flex items-center justify-between text-[13px] text-ink-muted">
