...
class Warehouse(Base):
    ...
    facility_type: Mapped[str] = mapped_column(String(50), default="WAREHOUSE")
    ...
    total_capacity_mt: Mapped[int] = mapped_column(Integer, default=0)
    used_capacity_mt: Mapped[int] = mapped_column(Integer, default=0)
    available_capacity_mt: Mapped[int] = mapped_column(Integer, default=0)
    ...
    facility_tags: Mapped[str | None] = mapped_column(String(500), nullable=True)
    feasibility_note: Mapped[str | None] = mapped_column(String(1000), nullable=True)
